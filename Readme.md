   ...
   3. Set them by either
    ...
    4. The following variables are available:
        ...
        \*: `demo_ar_workflows_gitlab` requires extra variables. See [use case README](user-skel/ansible/roles/demo-ar-workflows-gitlab/README.md) for details.
         \*: `demo_release_validation_srg_gitlab` requires extra variables. See [use case README](user-skel/ansible/roles/demo-release_validation-srg-gitlab/README.md) for details.
